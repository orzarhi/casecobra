        ...
        return (
            <div className='w-full mt-24 flex justify-center'>
                <div className='flex flex-col items-center gap-2'>
                    ...
                    <p>This is might take a moment.</p>
                </div>
            </div>
        )
    }
        ...
        <div className='bg-white'>
            <div className='mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8'>
                ...
                <div>
                    ...
                    <div className='grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-xs'>
                        <div>
                        ...
                        <div>
                            ...
                            <p className='mt-2 text-zinc-700'>DHL, takes up to e working days</p>
                        </div>
                    </div>
                </div>
